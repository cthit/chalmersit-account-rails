class UsersController < ApplicationController
  ...
  private
    ...
    def ldap_user_params
      ...
      params.require(:ldap_user).permit(:nickname, :mail, :cn, :gn, :sn, :preferredLanguage, :notifyBy, { push_services: [{ pushbullet: push_service_attrs }, { pushover: push_service_attrs }] })
    end
end
